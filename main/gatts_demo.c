...
#define TEST_DEVICE_NAME            "NHA_HANG_KHUYEN_MAI_50%"
...
static esp_ble_adv_data_t adv_data = {
    ...
    .appearance = 0x00,
    .manufacturer_len = sizeof(manufacturer_data), // Cập nhật kích thước dữ liệu nhà sản xuất
    .p_manufacturer_data = manufacturer_data, // Cập nhật con trỏ tới mảng dữ liệu
    .service_data_len = 0,
    .p_service_data = NULL,
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_REG_EVT:
        ...
        esp_err_t set_dev_name_ret = esp_ble_gap_set_device_name("NHA_HANG_KHUYEN_MAI");
        if (set_dev_name_ret){
